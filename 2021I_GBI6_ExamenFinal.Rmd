...
author: 'Briñoles Villalva Lidia Rosa'
date: "`r Sys.Date()`"
output:
  html_document:
    highlight: espresso
...
```{r wd}
setwd("C:\\Users\\Usuario 1\\Desktop\\final\\Results")
getwd()
```
...
descr(cancer_mama) %>% tab_df(title = "Estadistica descriptiva del cancer de MAMA y su nivel de expresion de los diferentes genes",
                             file = "C:\\Users\\Usuario 1\\Desktop\\final\\Results\\mRNA_expr_summary.doc") 
...
ggsave("C:\\Users\\Usuario 1\\Desktop\\final\\Results\\boxplot3.png", width = 6, height = 8, dpi = 300)
...
ggsave("C:\\Users\\Usuario 1\\Desktop\\final\\Results\\regresion11.pdf", width = 6, height = 8, dpi = 300)
